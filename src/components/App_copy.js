...
function App() {
  ...
  const [showDailySpacePic, setShowDailySpacePic] = useState(false);
  ...
  return (
    <>
      ...
      <StyledButton onClick={() => setShowDailySpacePic(!showDailySpacePic)}></StyledButton>
      {data && showDailySpacePic && <DailySpacePic data={data} />}
